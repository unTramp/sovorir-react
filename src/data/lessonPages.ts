...
export const lessonPages: LessonPage[] = [
  {
    ...
    blocks: [
      ...
      { type: 'phrase', russian: 'Барев', armenian: '\u0532\u0561\u0580\u0587', transcription: 'barev', translation: '\u00ab\u0417\u0434\u0440\u0430\u0432\u0441\u0442\u0432\u0443\u0439\u00bb \u0438\u043b\u0438 \u00ab\u041f\u0440\u0438\u0432\u0435\u0442\u00bb', status: 'learned' },
      { type: 'phrase', russian: 'Барев дзез', armenian: '\u0532\u0561\u0580\u0587 \u0571\u0565\u0566', transcription: 'barev dzez', translation: '\u00ab\u0417\u0434\u0440\u0430\u0432\u0441\u0442\u0432\u0443\u0439\u0442\u0565\u00bb', status: 'review' },
      { type: 'phrase', russian: 'Вохджуйн', armenian: '\u0548\u0572\u057b\u0578\u0582\u0575\u0576', transcription: 'voghdjuyn', translation: '\u00ab\u041f\u0440\u0438\u0432\u0435\u0442\u0441\u0442\u0432\u0443\u044e!\u00bb', status: 'new' },

      { type: 'audio', sender: 'teacher', senderName: 'Лусине', text: 'Попробуйте произнести слово Բարև — Привет', duration: 12, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      { type: 'record', prompt: 'Произнесите: Բارev' },
      { type: 'audio', sender: 'student', senderName: 'Вы', text: 'Мой вариант произношения', duration: 8, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      { type: 'audio', sender: 'teacher', senderName: 'Лусине', text: 'Отлично! Обратите внимание на ударение в последнем слоге', duration: 18, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      ...
      { type: 'audio', sender: 'teacher', senderName: 'Лусине', text: 'Теперь попробуйте спросить «Как дела?» и ответить', duration: 10, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      { type: 'record', prompt: 'Произнесите: Ինչpes ek — Lav' },
      { type: 'audio', sender: 'student', senderName: 'Вы', text: 'Инчпес эк — Лав', duration: 6, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
    ],
  },
  {
    id: 2,
    blocks: [
      { type: 'audio', sender: 'teacher', senderName: 'Лусине', text: 'Переходим к прощаниям — это тоже очень важно!', duration: 8, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      ...
      { type: 'phrase', russian: 'Мнак баров', armenian: '\u0544\u0576\u0561\u0584 \u0562\u0561\u0580\u0578\u057e', transcription: 'mnak barov', translation: '\u00ab\u041f\u0440\u043e\u0449\u0430\u0439\u0442\u0565\u00bb' },
      { type: 'phrase', russian: 'Бари гишер', armenian: '\u0532\u0561\u0580\u056b \u0563\u056b\u0577\u0565\u0580', transcription: 'bari gisher', translation: '\u00ab\u0421\u043f\u043e\u043a\u043e\u0439\u043d\u043e\u0439 \u043d\u043e\u0447\u0438\u00bb' },

      { type: 'audio', sender: 'teacher', senderName: 'Лусине', text: 'Попробуйте сказать «До свидания»', duration: 6, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      { type: 'record', prompt: 'Произнесите: Ցtesutyun' },
      { type: 'audio', sender: 'student', senderName: 'Вы', text: 'Цтесутюн', duration: 5, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
      ...
      { type: 'phrase', russian: 'Шнорхакалутюн', armenian: '\u0547\u0576\u043e\u0440\u0570\u0561\u056f\u0561\u056c\u0578\u0582\u0569\u0575\u0578\u0582\u0576', transcription: 'shnorhakalutyun', translation: '\u00ab\u0421\u043f\u0430\u0441\u0438\u0431\u043e\u00bb' },
      { type: 'phrase', russian: 'Хндрем', armenian: '\u053d\u0576\u0564\u0440\u0565\u0574', transcription: 'khndrem', translation: '\u00ab\u041f\u043e\u0436\u0430\u043b\u0443\u0439\u0441\u0442\u0430\u00bb' },

      { type: 'audio', sender: 'teacher', senderName: 'Лусине', text: 'Отлично! На сегодня достаточно. Повторите все слова дома и запишите голосовое с чтением текста', duration: 22, src: 'https://pub-eda80acf66874b9e9fa764f5722fdf1b.r2.dev/audio1.opus' },
    ],
  },
];
